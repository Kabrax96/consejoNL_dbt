/*
===========================================================================================================
Model Name : t2__finanzas__ingresos_detallado_cp
Author : Alejandro Morales Benavides
Date : September 24th, 2025
Usage : dbt build --select t2__finanzas__ingresos_detallado_cp
Objective :
...
Dependencies :
 - Source model: t1__finanzas__ingresos_detallado_cp
Assumptions/Notes :
 ...
 - CP version of ingresos_detallado intermediate model.
===========================================================================================================
History :
-----------------------------------------------------------------------------------------------------------
...
Alejandro Morales Benavides | 2025-09-24 | consejonl | Created CP version of Ingresos Detallado intermediate model.
-----------------------------------------------------------------------------------------------------------
===========================================================================================================
*/
...
with base as (
    ...
    from {{ ref('t1__finanzas__ingresos_detallado_cp') }}
    {% if is_incremental() %}
