/*
===========================================================================================================
Model Name          : t3__finanzas__ip_sobre_ild_quarterly_cp
Author              : Alejandro Morales Benavides
Date                : September 24th, 2025
Usage               : dbt build --select t3__finanzas__ip_sobre_ild_quarterly_cp

Objective           :
    This model - CP VERSION (Quarterly Aggregation):
      ...
      3) Outputs the ratio IP / ILD * 100 aggregated by quarter.
...
Assumptions/Notes   :
    ...
    - Quarterly aggregation - one record per quarter.
    - CP version of ip_sobre_ild model (quarterly grain).
...
-----------------------------------------------------------------------------------------------------------
Alejandro Morales Benavides   | 2025-09-24  | consejonl   | Created CP version of IP/ILD quarterly model.
-----------------------------------------------------------------------------------------------------------
===========================================================================================================
*/
...
{{
    config(
        ...
        tags=['finanzas', 'ip_sobre_ild', 't3', 'ip_sobre_ild_cp', 'quarterly'],
